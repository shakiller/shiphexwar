class HexagonalBattleship {
    ...
    getShipPositions(row, col, size, orientation) {
        ...
        const directions = [
            ...
            (step) => {
                if (step % 2 === 0) {
                    return { dr: 0, dc: 1 }; // Четные шаги: вправо
                } else {
                    return { dr: -1, dc: 1 }; // Нечетные шаги: вверх-вправо
                }
            },
            ...
            (step) => {
                if (step % 2 === 0) {
                    return { dr: 0, dc: -1 }; // Четные шаги: влево
                } else {
                    return { dr: 1, dc: -1 }; // Нечетные шаги: вниз-влево
                }
            },
            ...
            (step) => {
                if (step % 2 === 0) {
                    return { dr: -1, dc: -1 }; // Четные шаги: вверх-влево
                } else {
                    return { dr: 0, dc: -1 }; // Нечетные шаги: влево
                }
            },
            ...
            (step) => {
                if (step % 2 === 0) {
                    return { dr: -1, dc: 1 }; // Четные шаги: вверх-вправо
                } else {
                    return { dr: 0, dc: 1 }; // Нечетные шаги: вправо
                }
            }
        ];
